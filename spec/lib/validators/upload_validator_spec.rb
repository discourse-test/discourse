...
RSpec.describe UploadValidator do
  ...
  describe "validate" do
    ...
    describe "upload for site settings" do
      ...
      it "rejects non-image uploads when no accepted_extensions specified" do
      ...
      context "with accepted_extensions" do
        before do
      ...
      context "with site_setting_name but no accepted_extensions" do
        before do
